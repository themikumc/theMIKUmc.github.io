<template>
  <section class="h-[calc(100dvh-11rem)] overflow-hidden md:h-[calc(100dvh-12rem)]">
    ...
    >
      ...
      <p class="rise-3 bright-cyan-text flex items-center justify-center gap-3 text-base font-semibold lowercase sm:text-lg">
        <span class="tracking-[0.35em]">dev</span>
        <span class="tracking-normal opacity-80">|</span>
        <span class="tracking-[0.22em]">editor</span>
      </p>
      <div
